...
#Call the Method GetEnvelopeInformation passing the Envelope Id to know its info
response =  docusignMethod.GetEnvelopeInformation('8db590e9-ed97-4fd1-9f74-51e8a7a3174b')
print response
